...
def main() -> None:
    builder = ModelBuilder(metadata={"case": "routing_blackbox_auto_preset"})
    ...
    print_solution(
        "blackbox routing solved through automatically selected preset",
        result.final_solution,
        extra={
            "sequence_variable": route.node_id,
