...
def main() -> None:
    ...
    print_solution(
        "hybrid production planning solved through alternating heuristic and exact phases",
        result.final_solution,
        extra={
            "demands": {"product_a": demand_a, "product_b": demand_b},
            "due_date": due_date,
            "phase_trace": [
                {
            ...
            "note": "The model keeps linear quantity balance and interval scheduling in one DAG, then lets the orchestrator alternate heuristic seeding with exact CP-SAT refinement.",
        },
    )
